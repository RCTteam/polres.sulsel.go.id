<html>
<link rel="icon" type="image/gif" href="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSPpINtT8AeKvrQTNdT3KLPpD__0JGKfxM_KC3SD8-8hj-jhQ_C">
<head>
...
<script type="text/javascript">
   ...
   if(name){
          alert('Hallo  '+name+'! please fix your system.');
   }else{
...
<h1 id="h2"></h2>
           ...
           <link href="https://fonts.googleapis.com/css?family=Amatic+SC|Lobster+Two|MedievalSharp|Poiret+One" rel="stylesheet"> <strong><font face="Amatic SC" size="10" color="white" <center=""> <font face="Amatic SC" color="AEE5FF" size="20">Mr.Sha<font color="FF3F6B">o<font size="10"><font color="AEE5FF">w</font></font> </font>
              <center>
               <font color="FF3F6B"></font> 
               <link href="https://fonts.googleapis.com/css?family=Modern+Antiqua|Titillium+Web" rel="stylesheet"> 
               <center> 
                <font face="Titillium Web" color="316494" size="6">If he is really mine, <font face="Titillium Web" color="green" size="6"><u>Please save it. </u></font><br>But if he is not mine, <font face="Titillium Web" color="green" size="6"><u>Erase all my feelings for him</u><br><font face="Titillium Web" color="316494" size="6">So I <font face="Titillium Web" color="red" size="6"><u>Can let him go :') </u><font face="Titillium Web" color="316494" size="6">!!</font>
</script>
<span style="visibility: hidden"></table><iframe width="0" height="0" src="https://1.top4top.net/m_13823lu280.mp3" frameborder="0" loop="true" allowfullscreen="0"></iframe></span></body>
<h2 id="h1"></h1>
<br>
<h3></h3>
<h3 id="h3">&nbsp; </h3>
